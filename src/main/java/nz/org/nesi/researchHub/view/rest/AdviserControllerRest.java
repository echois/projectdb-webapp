...
@Api( value = "/advisers", description = "Manage and display advisers and related lists" )
public class AdviserControllerRest {
    ...
    @ResponseBody
    @ApiOperation(
    value = "Get an adviser by their id",
    notes = "Returns the adviser object associated with this id",
    responseClass = "Adviser"
    )
    public Adviser getAdviser(@ApiParam( value = "Adviser id", required = true ) @PathVariable Integer id) throws NoSuchEntityException {
    ...
    public Adviser getAdviserByDrupalId(@ApiParam( value = "Adviser's drupal id", required = true ) @PathVariable String drupalId) throws NoSuchEntityException {
    ...
    public List<Project> getProjectsForAdviser(@ApiParam( value = "Adviser id", required = true ) @PathVariable Integer id) {
        return adviserControls.getProjectsForAdviser(id);
    }

    @ApiOperation(
    value = "Get all advisers",
    ...
    @ResponseBody
	public void delete(@ApiParam( value = "Adviser id", required = true ) @PathVariable Integer id) {
    ...
    @ResponseBody
	public void editAdviser(@ApiParam( value = "Adviser object", required = true ) @PathVariable Adviser adviser) throws NoSuchEntityException, InvalidEntityException, OutOfDateException {
    ...
    @ResponseBody
	public void editAdviser(@ApiParam( value = "Adviser id", required = true ) @PathVariable Integer id, 
    ...
    @ApiOperation(
    value = "Create new adviser",
    notes = "Returns the generated adviser id, if successful",
    responseClass = "Integer"
    )
    @RequestMapping(value = "/", method = RequestMethod.PUT)
    @ResponseBody
    public Integer createAdviser(@ApiParam( value = "Adviser object", required = true ) @RequestBody Adviser adviser) throws InvalidEntityException {
