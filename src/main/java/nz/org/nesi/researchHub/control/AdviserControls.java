...
public class AdviserControls extends AbstractControl {
	...
	public static void main(String[] args) throws Exception {
		...
		AdviserControls ac = (AdviserControls) context
	 ...
	 */
	public void editAdviser(Adviser adviser) throws NoSuchEntityException,
			InvalidEntityException, OutOfDateException {
		validateAdviser(adviser);
		if (adviser.getId() != null) {
	 ...
	 * @throws OutOfDateException
	 */
	public void editAdviser(Integer id, String field, String timestamp,
			String data) throws NoSuchEntityException, InvalidEntityException,
			OutOfDateException {
		if (id != null) {
	 ...
	 *             if there is adviser problem with the database
	 */
	public Adviser getAdviserByDrupalId(String drupalId)
		...
		try {
			...
			throw new NoSuchEntityException(
					...
					Adviser.class, Integer.valueOf(drupalId));
		} catch (Exception e) {
	...
	public String getDrupalIdByAdviserId(Integer id)
			throws NoSuchEntityException {
		if (id == null) {
			throw new IllegalArgumentException("No adviser id provided");
		}
	...
	private void validateAdviser(Adviser a) throws InvalidEntityException {
		...
		if (a.getPhone().trim() != "" && !a.getPhone().matches(".+[0-9].+")) throw new InvalidEntityException(
				"Phone must contain at least one digit", Adviser.class, "phone");
		if (a.getEmail().trim() != "" && !a.getEmail().matches(".+@.+[.].+")) throw new InvalidEntityException(
				"Not a valid email", Adviser.class, "email");
