...
<body>
	...
	<div id="body">
		...
		<a href="<%=request.getContextPath()%>/html/editproject">Create
			new project</a><br>
		<!--
  ...
  -->
		...
		<form method="get">
			...
			<p>
				Filter where any project text contains: <input type="text"
					id="query" name="query" size="20" /> <input type="submit" />
			</p>
		...
		<h3>
			Projects
			<c:if test="${not empty query}">containing the phrase ${query} </c:if>
			(${f:length(projects)})
		</h3>
