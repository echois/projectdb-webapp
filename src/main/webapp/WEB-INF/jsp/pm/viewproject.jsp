...
<body>
	...
	<div id="body">
		...
		<a
			href="<%=request.getContextPath()%>/html/editproject?id=${pw.project.id}">Edit</a>
		| <a
			onclick="return (confirm('Are you sure you want to delete this project?'))"
			href="<%=request.getContextPath()%>/html/deleteproject?id=${pw.project.id}">Delete</a>
		...
		<table border="0" cellspacing="0" cellpadding="5">
			...
			<tr>
				...
				<td><c:forEach items="${pw.projectFacilities}" var="facility">
		...
		<a
			href="${jobauditBaseProjectUrl}to_y=<fmt:formatDate value="${today}" pattern="y" />&to_m=11&project=${pw.project.projectCode }">Jobaudit
			record for project</a> <br /> NB: Jobaudit currently only records data on
		nesi projects (e.g. nesi00001) <br>
		...
		<a href="${mailto}">Mail all researchers on project</a> <br>
			...
			<tbody>
				<c:forEach items="${pw.reviews}" var="review">
					<tr>
						...
						<td>${review.notes}</td>
						<td><c:forEach items="${review.attachments}" var="attachment">
